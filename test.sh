...
# FINAL
# python main.py --MODEL DCN --TEST_SIZE 3e-6 --EPOCHS 1 --PATIENCE_LIMIT 100 --MESSAGE DCN_FINAL
# 2.1586393288117782

# 20221101_142635_DFM_embed_dim_32_dropout_0.2_use_bn_True_epochs_2_state_category_new_language_year
# python main.py --MODEL DFM --TEST_SIZE 3e-6 --PATIENCE_LIMIT 100 --LR 1e-4 --DFM_EMBED_DIM 32 --DFM_HIDDEN_UNITS 512 256 --DFM_DROPOUT 0.2 --DFM_USE_BN True --EPOCHS 2 --MESSAGE FINAL
# 2.1886153219833475


# python main.py --MODEL DFM --PATIENCE_LIMIT 100 --LR 1e-4 --DFM_EMBED_DIM 32 --DFM_HIDDEN_UNITS 512 256 --DFM_DROPOUT 0.2 --DFM_USE_BN True --EPOCHS 10 --MESSAGE embed_dim_5_dropout_0.2_use_bn_True_epochs_10_state_language_category

python main.py --MODEL WDN --PATIENCE_LIMIT 100 --LR 1e-3 --EPOCHS 10 --MESSAGE tmp