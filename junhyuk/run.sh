...
# python3 main.py --EPOCHS 1 --TEST_SIZE 0.1 --MODEL NCF
python3 main.py --EPOCHS 3 --MODEL WDN
...
# python ensemble.py --ENSEMBLE_FILES 20221103_092547_NCF_kjh,20221103_092625_NCF_kjh --ENSEMBLE_STRATEGY WEIGHTED --ENSEMBLE_WEIGHT 0.5,0.5
